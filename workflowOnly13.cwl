...
outputs:
  unmapped13_R1:
    type: File[]
    outputSource: humanMapper_chm13/unmapped13_R1
  unmapped13_R2:
    type: File[]
    outputSource: humanMapper_chm13/unmapped13_R2
  kraken2_output:
    type: File[]
...
steps:
  ...
  humanMapper_chm13:
    ...
    in:
      ...
      threads: threads
    out: [unmapped13_R1, unmapped13_R2]
  kraken2:
    run: cwl/kraken2.cwl
    scatter: [read_1, read_2]
    scatterMethod: dotproduct
    in:
      read_1: humanMapper_chm13/unmapped13_R1
      read_2: humanMapper_chm13/unmapped13_R2
      db_path: db_path
      threads: threads
    out: [kraken2, report] 
  kraken-biom:
